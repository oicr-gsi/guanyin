...
VALUES ('jsonReport', '1.0', 'report', '{"type":"object", "required":"false", "properties":{"Instrument":{"type":"string", "required":"false"}, "runName":{"type":"string", "required":"false"}}}');

Insert INTO report_record (report_id, files_in, report_path, notification_targets, notification_message, parameters)
VALUES (1, '{"file_path":["p1"]}','/oicr/data/archive/r1','{"email":"xluo@oicr.on.ca"}', 'here is the run report', '{"runName":"170623_D00331_0244_BCB1LMANXX", "instrument":"HiSeq"}');

Insert INTO report (name, version, category, permitted_parameters)
VALUES ('jsonReport', '1.1', 'report', '{"type":"object", "required":"false", "properties":{"Instrument":{"type":"string", "required":"false"}, "runName":{"type":"string", "required":"false"}}}');

Insert INTO report_record (report_id, files_in, report_path, notification_targets, notification_message, parameters)
VALUES (2, '{"file_path":["p1", "p2"]}','/oicr/data/archive/r2','{"email":"xluo@oicr.on.ca"}', 'here is the run report', '{"runName":"161017_M00146_0050_000000000-AW48L", "instrument":"MiSeq"}');
...
Insert INTO report_record (report_id, files_in, report_path, notification_targets, notification_message, parameters)
VALUES (4, '{"file_path":["p1", "p2", "p3", "p4"]}','/oicr/data/archive/r4','{"email":"xluo@oicr.on.ca"}', 'Here is the voverage report for HALT', '{"project":"HALT", "instrument":"MiSeq"}');
